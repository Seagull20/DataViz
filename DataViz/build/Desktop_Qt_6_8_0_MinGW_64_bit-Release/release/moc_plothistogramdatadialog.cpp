...
struct qt_meta_stringdata_CLASSPlotHistogramDataDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPlotHistogramDataDialogENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPlotHistogramDataDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PlotHistogramDataDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPlotHistogramDataDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPlotHistogramDataDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPlotHistogramDataDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void PlotHistogramDataDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PlotHistogramDataDialog::*)(DataSet * , int , QString );
            if (_t _q_method = &PlotHistogramDataDialog::sendHistogramData_SIGNAL; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *PlotHistogramDataDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPlotHistogramDataDialogENDCLASS.stringdata0))
