...
public:
    ...
    void setupUi(QMainWindow *ParentWindow)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/aboutSymbol.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionAbout->setIcon(icon1);
        actionHelp = new QAction(ParentWindow);
        actionHelp->setObjectName("actionHelp");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/helpSymbol.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
