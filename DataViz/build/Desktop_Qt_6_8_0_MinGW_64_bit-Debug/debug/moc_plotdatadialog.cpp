...
struct qt_meta_stringdata_CLASSPlotDataDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPlotDataDialogENDCLASS = QtMocHelpers::stringData(
    "PlotDataDialog",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPlotDataDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PlotDataDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPlotDataDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPlotDataDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPlotDataDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void PlotDataDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PlotDataDialog::*)(DataSet * );
            if (_t _q_method = &PlotDataDialog::sendChosenDataSet_SIGNAL; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *PlotDataDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPlotDataDialogENDCLASS.stringdata0))
