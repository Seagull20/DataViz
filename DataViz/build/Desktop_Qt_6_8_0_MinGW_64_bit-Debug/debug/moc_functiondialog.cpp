...
struct qt_meta_stringdata_CLASSFunctionDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFunctionDialogENDCLASS = QtMocHelpers::stringData(
    "FunctionDialog",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFunctionDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FunctionDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFunctionDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFunctionDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFunctionDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *FunctionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFunctionDialogENDCLASS.stringdata0))
